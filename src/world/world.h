...
class World {
    ...
    private:        
        ...
        void populateChunkBitMask(Chunk& chunk, glm::ivec3 chunkCoord, u_int64_t x_solid_mask[CHUNK_SIZE+2][CHUNK_SIZE+2], u_int64_t y_solid_mask[CHUNK_SIZE+2][CHUNK_SIZE+2], u_int64_t z_solid_mask[CHUNK_SIZE+2][CHUNK_SIZE+2], u_int64_t x_water_mask[CHUNK_SIZE+2][CHUNK_SIZE+2], u_int64_t y_water_mask[CHUNK_SIZE+2][CHUNK_SIZE+2], u_int64_t z_water_mask[CHUNK_SIZE+2][CHUNK_SIZE+2], u_int64_t x_opaque_mask[CHUNK_SIZE+2][CHUNK_SIZE+2], u_int64_t y_opaque_mask[CHUNK_SIZE+2][CHUNK_SIZE+2], u_int64_t z_opaque_mask[CHUNK_SIZE+2][CHUNK_SIZE+2]);
        ...
        void bitMaskFaceCulling(Chunk& chunk, glm::ivec3 chunkCoord, u_int64_t x_solid_mask[CHUNK_SIZE+2][CHUNK_SIZE+2], u_int64_t y_solid_mask[CHUNK_SIZE+2][CHUNK_SIZE+2], u_int64_t z_solid_mask[CHUNK_SIZE+2][CHUNK_SIZE+2], u_int64_t x_water_mask[CHUNK_SIZE+2][CHUNK_SIZE+2], u_int64_t y_water_mask[CHUNK_SIZE+2][CHUNK_SIZE+2], u_int64_t z_water_mask[CHUNK_SIZE+2][CHUNK_SIZE+2], u_int64_t x_opaque_mask[CHUNK_SIZE+2][CHUNK_SIZE+2], u_int64_t y_opaque_mask[CHUNK_SIZE+2][CHUNK_SIZE+2], u_int64_t z_opaque_mask[CHUNK_SIZE+2][CHUNK_SIZE+2], std::vector<float>& meshData);
